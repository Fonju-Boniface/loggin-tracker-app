...
const TermPo = () => {
  return (
    <div className="TermPo">
      <h3 className="HeaderNAme">Tearms & Policy</h3>
      <br />
      <br />
      <br />
      ...
      <div className="boxes display">
        <div className="box display">
          <p>
            Sample Website Terms and Conditions Template Please read these terms
            and conditions ("terms and conditions", "terms") carefully before
            using [website URL] website (“website”, "service") operated by
            [company name] ("us", 'we", "our").
          </p>
        </div>
        <div className="box display">
        ...
        <div className="box display">
          ...
          <p>
            ...
            age misrepresentation. Intellectual property You agree that all
            materials, products, and services provided on this website are the
            property of [company name], its affiliates, directors, officers,
            ...
            [company name]’s intellectual property in any way, including
            electronic, digital, or new
          </p>
        </div>
        <div className="box display">
          <b>trademark registrations.</b>
          <p>
            You grant [company name] a royalty-free and non-exclusive license to
